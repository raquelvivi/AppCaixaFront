<template>
    ...
    <section>
        ...
        <div class="linha">
            <div>
                <p>Total: {{ valorTotal.toLocaleString('pt-BR', { minimumFractionDigits: 2, maximumFractionDigits: 2 })
                    }}</p>
                <p>Produtos: {{ quantidadeTotal }}</p>
            </div>
            <!-- <input v-model="pagoCom" type="text" placeholder="Ex: Dinheiro"> -->
            <select v-model="pagoCom" style="width: 100px;">
        ...
        <div class="salvar">
            <div class="salvarDiv">
                <p>Troco: </p>
                <p class="pSalvar">{{ (recebido - valorTotal).toLocaleString('pt-BR', {
